                ...
                <nav class="sidebar-nav">
                    ...
                    <?php if(@$sess['router_id']){ ?>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-access-point-network"></i><span
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="<?php echo base_url('ppp/pppoe') ?>" class="sidebar-link"><i class="mdi mdi-chart-arc"></i> <span class="hide-menu"> PPPoe Server </span></a></li>
                                
                                <li class="sidebar-item"><a href="<?php echo base_url('ppp/secret') ?>" class="sidebar-link"><i class="mdi mdi-account-convert"></i> <span class="hide-menu"> PPPoe Users </span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo base_url('customers/category') ?>" aria-expanded="false"><i class="mdi mdi-border-all"></i><span
                                    class="hide-menu">Category</span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="<?php echo base_url('customers/users') ?>" aria-expanded="false"><i class="mdi mdi-account-multiple-outline"></i><span
